...
| {counter:index} | 結晶生命体のユニーク変異武装を使いたい                               | unique_mutation_crystalline
| {counter:index} | 独裁制配列かつ統治者が科学者な時もレア研究は出て欲しい               | auth_cyber_dictatorial_collectivist_tech
| {counter:index} | 国是「執着的指令」を持ったAI国家が自壊するのを防ぐやつ               | purge_clips
| {counter:index} | サイオニック・オーラやけくそ可視化Mod                                | psionic_aura
| {counter:index} | 宗主国「シュラウド・シール解体しろ」属国「はい……」                 | shroud_seal
| {counter:index} | 深宇宙シタデルは基地の近くに作ってくれないか                         | deepspace_citadel_inner_radius_percentage
|===
